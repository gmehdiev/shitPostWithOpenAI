...
import { pushComments } from './utils/pushComments.js';
import { pushPosts } from './utils/pushPosts.js';
import { createAIComments } from './utils/createAICOMMENTS.js';
import { createAIPosts } from './utils/createAIPosts.js';
...
const task = cron.schedule('*/5 * * * *', createAIComments);
const comment = cron.schedule('*/30 * * * * *',createAIPosts );
task.start()
comment.start()
